            ...
            <div className="mx-auto flex w-full max-w-4xl flex-col gap-10 px-6 py-8 lg:px-8">
                <article className="space-y-6 py-16">
                    ...
                    <p className="text-muted-foreground leading-8">
                        This is a product placeholder for how Dugble expects to
                        handle account, workspace, recipient, message, and
                        webhook data. It should be replaced by counsel-reviewed
                        legal language before launch.
                    </p>
                    <p className="text-muted-foreground leading-8">
                        The product principle is to collect what message
                        delivery needs, protect operational logs, and make

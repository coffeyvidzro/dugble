...
export const metadata: Metadata = {
    title: "About Dugble | A2P Messaging Infrastructure",
    description:
            ...
            <div className="mx-auto flex w-full max-w-4xl flex-col gap-12 px-6 py-8 lg:px-8">
                <section className="space-y-6 py-16">
                    ...
                    <p className="text-lg text-muted-foreground leading-8">
                        Dugble is being built for teams that send
                        customer-critical messages — OTPs, receipts, alerts, and
                        updates — and need to know exactly what happened after
                        every API call.
                    </p>
                    <p className="text-lg text-muted-foreground leading-8">
                        The point of view is simple: send the message, keep the
                        receipt, and make every failure easier to explain.
                    </p>
                </section>
            </div>
        </main>

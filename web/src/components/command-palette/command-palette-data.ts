...
export type CommandPaletteScope = "marketing" | "dashboard";

export const MARKETING_GROUP_ORDER = [
  "Features",
  "Resources",
  "Recent updates",
  "Company",
...
export function getCommandItems(scope: CommandPaletteScope): CommandItem[] {
  return scope === "dashboard"
    ? dashboardItems
    : [...marketingItems, ...changelogItems];
}

export function getGroupOrder(scope: CommandPaletteScope): string[] {
  return scope === "dashboard" ? DASHBOARD_GROUP_ORDER : MARKETING_GROUP_ORDER;
}

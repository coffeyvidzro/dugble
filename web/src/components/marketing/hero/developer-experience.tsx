        ...
        <section className="grid gap-10 rounded-2xl border bg-card/60 p-6 md:p-10 lg:grid-cols-2 lg:gap-8">
            <Reveal className="space-y-5">
                ...
                <p className="leading-7 text-muted-foreground">
                    Dugble is built around the details developers care about:
                    clear request shapes, safe retries, useful failures, and
                    webhook events your application can trust.
                </p>

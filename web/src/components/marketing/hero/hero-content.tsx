    ...
    return (
        <div className="space-y-5 animate-fade-up [animation-delay:80ms]">
            ...
            <p className="max-w-lg text-pretty text-base leading-7 text-muted-foreground md:text-lg">
                Dugble is an email and SMS API for OTPs, receipts, and account
                alerts with a status for every message and a webhook for every
                state change, so nothing gets lost between your server and your
                customer.
            </p>
        </div>
    );

    ...
    <section className="space-y-8">
      <Reveal className="max-w-2xl space-y-3">
        ...
        <p className="leading-7 text-muted-foreground">
          Underneath the SMS and Email APIs is a lightweight Go HTTP server
          handling multi-tenant identity and team management, the same
          foundation a full product needs, not a messaging script with an API
          bolted on top.
        </p>
      </Reveal>

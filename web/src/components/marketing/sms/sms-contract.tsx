    ...
    <section className="space-y-6">
      <Reveal className="max-w-2xl space-y-3">
        ...
        <p className="leading-7 text-muted-foreground">
          Include the recipient, template, and an idempotency key. A successful
          response returns a message ID and its first delivery state, never a
          silent 200 with nothing to trace.
        </p>
      </Reveal>

...
const channels: {
...
}[] = [
  {
    ...
    description: "Early access, feedback, partnerships, and everything else.",
    action: { label: "hello@dugble.com", href: "mailto:hello@dugble.com" },
  },
  {
    icon: ShieldCheck,
    title: "Security reports",
    description: "Found a vulnerability? We'd rather hear it from you first.",
    action: { label: "Read our security page", href: "/security" },
  },
  {
    icon: Activity,
    title: "Status & incidents",
    description: "Check current uptime before reaching out about an outage.",
    ...
    <div className="space-y-4">
      ...
      >
        ...
        <p className="text-sm leading-6 text-muted-foreground">
          Remote-first, building for African startups and teams - and the
          developers writing to them from anywhere else.
        </p>
      </Reveal>
    </div>
  );

    ...
    <section className="space-y-6">
      <Reveal className="max-w-2xl space-y-3">
        ...
        <p className="leading-7 text-muted-foreground">
          A transactional send names the recipient, the template, and structured
          template_data, never raw HTML mixed with product logic. The response
          hands back a message ID your team can trace through every delivery
          event.
        </p>
      </Reveal>

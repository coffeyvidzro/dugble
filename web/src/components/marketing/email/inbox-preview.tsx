    ...
    <Reveal className="overflow-hidden rounded-2xl border bg-card shadow-lg shadow-black/5 dark:shadow-2xl dark:shadow-black/40">
      ...
      <div className="grid gap-0 sm:grid-cols-[0.8fr_1.2fr]">
        <div className="hidden border-r p-3 sm:block">
          ...
          <div className="mt-1 space-y-0.5">
            <div className="rounded-lg bg-muted/70 px-2 py-2">
              <p className="text-xs font-medium">Your receipt from Dugble</p>
              <p className="mt-0.5 font-mono text-[10px] text-muted-foreground">
                just now
              </p>
            </div>
            <div className="px-2 py-2 opacity-40">
              <p className="text-xs font-medium">Weekly usage summary</p>
            </div>
            <div className="px-2 py-2 opacity-40">
              <p className="text-xs font-medium">Password reset requested</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4 p-5">
          <div>
            <p className="text-sm font-semibold">Your receipt from Dugble</p>
          ...
          <p className="text-sm leading-6 text-muted-foreground">
            ...
            was received. A copy of this receipt is attached for your records.
          </p>

  ...
  return (
    ...
    >
      <p className="max-w-2xl leading-7 text-muted-foreground">
        Dugble is early-stage and doesn't hold formal certifications like SOC 2
        yet. What's on this page reflects what's actually built today, not a
        compliance checklist - and it's the foundation the rest of this is built
        toward.
      </p>

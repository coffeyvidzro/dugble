    ...
    <section className="space-y-8">
      <Reveal className="max-w-2xl space-y-3">
        ...
        <p className="leading-7 text-muted-foreground">
          Not every request hits every stage. A signed webhook doesn't need a
          CSRF check, a dashboard click doesn't need a signature but nothing
          skips scope and session checks.
        </p>
      </Reveal>

    ...
    <section className="grid gap-8 lg:grid-cols-[1fr_1fr]">
      <Reveal className="space-y-4">
        ...
        <p className="leading-7 text-muted-foreground">
          Keep clear space around the mark equal to at least the height of the
          mark itself. Don't let text, edges, or other logos crowd inside that
          boundary.
        </p>
        <ul className="space-y-2 text-sm text-muted-foreground">
          <li>
            <span className="font-medium text-foreground">Minimum size:</span>{" "}
            20px tall for the mark alone, 24px tall for the lockup.
          </li>
          <li>
            <span className="font-medium text-foreground">Don't:</span> rotate,
            skew, recolor, or add effects like drop shadows or gradients.
          </li>
        </ul>
      </Reveal>

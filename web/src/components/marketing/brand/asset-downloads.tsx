    ...
    <section id="assets" className="scroll-mt-24 space-y-8">
      <Reveal className="max-w-2xl space-y-3">
        ...
        <p className="leading-7 text-muted-foreground">
          Vector, so it scales cleanly from a favicon to a conference banner.
          Need PNG or a different format? Email us and we'll send it over.
        </p>
      </Reveal>
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <Image
                    ...
                    alt=""
                    width={
                      asset.file.includes("mark")
                        ? 40
                        : asset.file.includes("wordmark")
                          ? 170
                          : 222
                    }
                    height={40}
                ...
                <div>
                  ...
                  <p className="font-mono text-xs text-muted-foreground">SVG</p>
                </div>
              </div>

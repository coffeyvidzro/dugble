    ...
    <section className="space-y-8">
      <Reveal className="max-w-2xl space-y-3">
        ...
        <p className="leading-7 text-muted-foreground">
          Signal, pending, and danger aren't decoration they're the same three
          states used across every status pill, log entry, and webhook event in
          the product. Reuse them that way, not as a general-purpose accent
          palette.
        </p>
      </Reveal>

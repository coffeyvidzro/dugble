...
RETURNING id, team_id, sender_id, to_number, from_name, body, status, provider_id, provider_message_id, segments, cost_micros, error_message, metadata, submitted_at, delivered_at, created_at, updated_at, traffic_class, pricing_rule_id, unit_cost_micros
`
...
SELECT id, team_id, sender_id, to_number, from_name, body, status, provider_id, provider_message_id, segments, cost_micros, error_message, metadata, submitted_at, delivered_at, created_at, updated_at, traffic_class, pricing_rule_id, unit_cost_micros
FROM sms_messages
WHERE id = $1
  AND team_id = $2
`

...
type Querier interface {
	...
	ArchiveInboxReceipt(ctx context.Context, arg ArchiveInboxReceiptParams) (InboxReceipt, error)
	...
	CancelNotificationRun(ctx context.Context, arg CancelNotificationRunParams) (NotificationRun, error)
	CancelPendingNotificationSteps(ctx context.Context, arg CancelPendingNotificationStepsParams) ([]NotificationStepRun, error)
	...
	ClaimNotificationRuns(ctx context.Context, arg ClaimNotificationRunsParams) ([]NotificationRun, error)
	ClaimRunnableNotificationStepRuns(ctx context.Context, arg ClaimRunnableNotificationStepRunsParams) ([]NotificationStepRun, error)
	...
	CompleteNotificationControlStep(ctx context.Context, arg CompleteNotificationControlStepParams) (NotificationStepRun, error)
	CompleteNotificationEmailStep(ctx context.Context, arg CompleteNotificationEmailStepParams) (NotificationStepRun, error)
	CompleteNotificationInboxStep(ctx context.Context, arg CompleteNotificationInboxStepParams) (NotificationStepRun, error)
	CompleteNotificationSMSStep(ctx context.Context, arg CompleteNotificationSMSStepParams) (NotificationStepRun, error)
	...
	CreateInboxReceipt(ctx context.Context, arg CreateInboxReceiptParams) (InboxReceipt, error)
	CreateInboxReceipts(ctx context.Context, arg CreateInboxReceiptsParams) ([]InboxReceipt, error)
	CreateMFALoginChallenge(ctx context.Context, arg CreateMFALoginChallengeParams) error
	CreateNotificationRun(ctx context.Context, arg CreateNotificationRunParams) (NotificationRun, error)
	CreateNotificationStepRun(ctx context.Context, arg CreateNotificationStepRunParams) (NotificationStepRun, error)
	CreateNotificationWorkflow(ctx context.Context, arg CreateNotificationWorkflowParams) (NotificationWorkflow, error)
	CreateNotificationWorkflowVersion(ctx context.Context, arg CreateNotificationWorkflowVersionParams) (NotificationWorkflowVersion, error)
	...
	DeleteNotificationPreference(ctx context.Context, arg DeleteNotificationPreferenceParams) (int64, error)
	...
	GetInboxMessageBySource(ctx context.Context, arg GetInboxMessageBySourceParams) (InboxMessage, error)
	GetInboxReceipt(ctx context.Context, arg GetInboxReceiptParams) (InboxReceipt, error)
	...
	GetNotificationRecipientByExternalID(ctx context.Context, arg GetNotificationRecipientByExternalIDParams) (NotificationRecipient, error)
	GetNotificationRun(ctx context.Context, arg GetNotificationRunParams) (NotificationRun, error)
	GetNotificationRunForUpdate(ctx context.Context, arg GetNotificationRunForUpdateParams) (NotificationRun, error)
	GetNotificationStepRun(ctx context.Context, arg GetNotificationStepRunParams) (NotificationStepRun, error)
	GetNotificationStepRunForUpdate(ctx context.Context, arg GetNotificationStepRunForUpdateParams) (NotificationStepRun, error)
	GetNotificationWorkflow(ctx context.Context, arg GetNotificationWorkflowParams) (NotificationWorkflow, error)
	GetNotificationWorkflowByKey(ctx context.Context, arg GetNotificationWorkflowByKeyParams) (NotificationWorkflow, error)
	GetNotificationWorkflowForUpdate(ctx context.Context, arg GetNotificationWorkflowForUpdateParams) (NotificationWorkflow, error)
	GetNotificationWorkflowVersion(ctx context.Context, arg GetNotificationWorkflowVersionParams) (NotificationWorkflowVersion, error)
	GetOAuthIdentity(ctx context.Context, arg GetOAuthIdentityParams) (OauthIdentity, error)
	GetPublishedNotificationWorkflowVersion(ctx context.Context, arg GetPublishedNotificationWorkflowVersionParams) (NotificationWorkflowVersion, error)
	...
	ListInboxFeed(ctx context.Context, arg ListInboxFeedParams) ([]ListInboxFeedRow, error)
	ListInboxMessages(ctx context.Context, arg ListInboxMessagesParams) ([]InboxMessage, error)
	ListNotificationPreferences(ctx context.Context, arg ListNotificationPreferencesParams) ([]NotificationPreference, error)
	ListNotificationRecipients(ctx context.Context, arg ListNotificationRecipientsParams) ([]NotificationRecipient, error)
	ListNotificationRuns(ctx context.Context, arg ListNotificationRunsParams) ([]NotificationRun, error)
	ListNotificationStepRuns(ctx context.Context, arg ListNotificationStepRunsParams) ([]NotificationStepRun, error)
	ListNotificationWorkflowVersions(ctx context.Context, arg ListNotificationWorkflowVersionsParams) ([]NotificationWorkflowVersion, error)
	ListNotificationWorkflows(ctx context.Context, arg ListNotificationWorkflowsParams) ([]NotificationWorkflow, error)
	...
	MarkInboxReceiptRead(ctx context.Context, arg MarkInboxReceiptReadParams) (InboxReceipt, error)
	MarkInboxReceiptSeen(ctx context.Context, arg MarkInboxReceiptSeenParams) (InboxReceipt, error)
	MarkNotificationRunCompleted(ctx context.Context, arg MarkNotificationRunCompletedParams) (NotificationRun, error)
	MarkNotificationRunFailed(ctx context.Context, arg MarkNotificationRunFailedParams) (NotificationRun, error)
	MarkNotificationRunRunning(ctx context.Context, arg MarkNotificationRunRunningParams) (NotificationRun, error)
	MarkNotificationRunWaiting(ctx context.Context, arg MarkNotificationRunWaitingParams) (NotificationRun, error)
	MarkNotificationStepFailed(ctx context.Context, arg MarkNotificationStepFailedParams) (NotificationStepRun, error)
	MarkNotificationStepWaiting(ctx context.Context, arg MarkNotificationStepWaitingParams) (NotificationStepRun, error)
	...
	PublishNotificationWorkflowVersion(ctx context.Context, arg PublishNotificationWorkflowVersionParams) (NotificationWorkflowVersion, error)
	...
	SetNotificationWorkflowPublishedVersion(ctx context.Context, arg SetNotificationWorkflowPublishedVersionParams) (NotificationWorkflow, error)
	SetVerificationServiceEnabled(ctx context.Context, arg SetVerificationServiceEnabledParams) (VerificationService, error)
	SkipNotificationStep(ctx context.Context, arg SkipNotificationStepParams) (NotificationStepRun, error)
	...
	UnarchiveInboxReceipt(ctx context.Context, arg UnarchiveInboxReceiptParams) (InboxReceipt, error)
	UpdateEmailRecipientState(ctx context.Context, arg UpdateEmailRecipientStateParams) (int64, error)
	UpdateNotificationRecipient(ctx context.Context, arg UpdateNotificationRecipientParams) (NotificationRecipient, error)
	...
	UpsertCategoryNotificationPreference(ctx context.Context, arg UpsertCategoryNotificationPreferenceParams) (NotificationPreference, error)
	UpsertNotificationRecipient(ctx context.Context, arg UpsertNotificationRecipientParams) (NotificationRecipient, error)
	UpsertWorkflowNotificationPreference(ctx context.Context, arg UpsertWorkflowNotificationPreferenceParams) (NotificationPreference, error)

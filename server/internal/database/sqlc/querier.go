...
type Querier interface {
	...
	CreateEmailProviderEvent(ctx context.Context, arg CreateEmailProviderEventParams) (int64, error)
	...
	GetEmailProviderEventByNotification(ctx context.Context, arg GetEmailProviderEventByNotificationParams) (EmailProviderEvent, error)
